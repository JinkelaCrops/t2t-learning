...
def main(_):
    ...
    DATA_DIR=../../../t2t_med/t2t_data/new_medicine
    TRAIN_DIR=../../../t2t_med/t2t_train/new_medicine/$PROBLEM/$MODEL-$HPARAMS
    ...
    FLAGS.data_dir = "../../../t2t_med/t2t_data/new_medicine"
    FLAGS.output_dir = f"../../../t2t_med/t2t_train/new_medicine/{FLAGS.problems}/{FLAGS.model}-{FLAGS.hparams_set}"
    FLAGS.gpuid = "0"
